...
export default function PlannerSectionArabic() {
  const [currentStep] = useState(1);
  const [selectedVibe, setSelectedVibe] = useState<string | null>(null);

  const vibes = [
    { icon: Utensils, label: "أكل", color: "text-accent-gold" },
    { icon: ShoppingBag, label: "تسوق", color: "text-accent-lilac" },
    { icon: Landmark, label: "ثقافة", color: "text-accent-teal" },
    { icon: Users, label: "عائلة", color: "text-accent-pink" }
  ];
    ...
    <section className="py-20 bg-gradient-to-br from-primary-700 to-primary-500 relative overflow-hidden" dir="rtl">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="font-ghayaty font-bold text-4xl lg:text-5xl mb-6 text-white" data-testid="planner-title-ar">
            خطط رحلتك <span className="text-accent-teal">الآمنة</span>
          </h2>
          <p className="text-xl text-gray-200 max-w-2xl mx-auto" data-testid="planner-subtitle-ar">
            المخطط الذكي بتاعنا يساعدك تعمل تجربة مثالية في بورسعيد في دقايق
          </p>
        </div>
          ...
          <div className="glass-card rounded-3xl p-8 md:p-12">
            ...
            <div className="mb-8">
              <div className="flex justify-between text-sm text-white mb-2">
                <span>خطوة {currentStep} من ٣</span>
            ...
            <div className="mb-8">
              <h3 className="font-ghayaty font-bold text-2xl text-white mb-6" data-testid="step-title-ar">
                إيه الفايب بتاعك؟
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {vibes.map((vibe, index) => (
                  <button
                    ...
                    data-testid={`vibe-ar-${vibe.label}`}
                  >
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white bg-opacity-5 rounded-xl p-4 border border-white border-opacity-10">
                <h4 className="text-white font-semibold mb-2 flex items-center gap-2">
                  ...
                  الخطوة ٢: اختار التاريخ والوقت
                </h4>
                <p className="text-gray-300 text-sm">اختار وقت الزيارة المثالي ليك</p>
              </div>
              <div className="bg-white bg-opacity-5 rounded-xl p-4 border border-white border-opacity-10">
                <h4 className="text-white font-semibold mb-2 flex items-center gap-2">
                  <Package className="w-5 h-5" />
                  الخطوة ٣: اختار باقتك
                </h4>
                <p className="text-gray-300 text-sm">من الباقات الاقتصادية للـ VIP</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <button 
                ...
                data-testid="button-build-plan-ar"
              >
